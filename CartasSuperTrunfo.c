...
int main() {
    ...
    //Aqui sera feito os calculos do densidadePopulaional, pibPerCapital e super poder.
    ...
    // como ainda não usado if e else no curso, procurei um jeito de usar so que sem ser if e else.
